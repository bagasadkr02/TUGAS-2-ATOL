                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        include '../../connection.php';
                                                        $id = $d['id'];
                                                        $query_edit  = mysqli_query($mysqli, "select * from users where id='$id'");
                                                            ...
                                                            <form method="post" action="update_action.php">
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>Username</td>
                                                                        <td>
                                                                            <input type="text" name="username" value="<?php echo $dEdit['username']; ?>">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>password</td>
                                                                        <td>
                                                                            <input type="text" name="password" value="<?php echo $dEdit['password']; ?>">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="modal-footer">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdropPass<?php echo $d['id']; ?>">EDIT-PASSWORD</a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        include '../../connection.php';
                                                        $id = $d['id'];
                                                        $query_password  = mysqli_query($mysqli, "select * from users where id='$id'");
